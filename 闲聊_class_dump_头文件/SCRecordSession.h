...
@class AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVCaptureMovieFileOutput, NSArray, NSDate, NSMutableArray, NSString, NSURL, SCAudioConfiguration, SCRecorder, SCVideoConfiguration;
...
@property(nonatomic) __weak SCRecorder *recorder; // @synthesize recorder=_recorder;
...
@property(readonly, nonatomic) _Bool recordSegmentReady;
...
- (id)assetRepresentingSegments;
- (id)playerItemRepresentingSegments;
