...
@interface SGDialogHelperWithdrawFailureNotice : SGDialogDetailCellModel
{
    NSString *_titleText;
    ...
    NSString *_remarksStr;
}

@property(copy, nonatomic) NSString *remarksStr; // @synthesize remarksStr=_remarksStr;
