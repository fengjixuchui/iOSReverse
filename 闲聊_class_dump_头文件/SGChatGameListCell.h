...
@class SGGameObject, UIButton, UIImageView, UILabel, UIView;
@protocol SGChatGameListCellProtocol;

@interface SGChatGameListCell : SGTableViewCellBase
{
    UIView *_bottomLine;
    SGGameObject *_gameVO;
    id <SGChatGameListCellProtocol> _delegate;
...
@property(nonatomic) __weak id <SGChatGameListCellProtocol> delegate; // @synthesize delegate=_delegate;
