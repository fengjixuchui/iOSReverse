...
@class UILabel;
@protocol SGLTBalanceHeadViewDelegate;

@interface SGLTBalanceHeadView : UIView
{
    long long _balance;
    id <SGLTBalanceHeadViewDelegate> _delegate;
    UILabel *_changeLab;
}

@property(retain, nonatomic) UILabel *changeLab; // @synthesize changeLab=_changeLab;
@property(nonatomic) id <SGLTBalanceHeadViewDelegate> delegate; // @synthesize delegate=_delegate;
