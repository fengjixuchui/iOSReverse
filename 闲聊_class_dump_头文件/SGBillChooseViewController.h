...
@class NSMutableArray, NSString, UIButton, UILabel, UIScrollView, UITableView, UITextField, UIView;

@interface SGBillChooseViewController : SGViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIScrollViewDelegate>
{
