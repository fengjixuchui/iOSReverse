...
@interface ReplyGroupChatMessageReq : GPBMessage
{
}
...
@property(retain, nonatomic) GPBInt64Array *atListArray; // @dynamic atListArray;
@property(readonly, nonatomic) unsigned long long atListArray_Count; // @dynamic atListArray_Count;
