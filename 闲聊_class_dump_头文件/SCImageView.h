...
@class CIImage, GLKView, MTKView, NSString, SCContext, SCSampleBufferHolder;
@protocol MTLCommandQueue;

@interface SCImageView : UIView <GLKViewDelegate, MTKViewDelegate>
{
...
@property(retain, nonatomic) SCSampleBufferHolder *sampleBufferHolder; // @synthesize sampleBufferHolder=_sampleBufferHolder;
...
@property(retain, nonatomic) SCContext *context; // @synthesize context=_context;
