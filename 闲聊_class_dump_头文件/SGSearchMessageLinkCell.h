...
@class SGSearchMessageLinkModel, UIImageView, UILabel;

@interface SGSearchMessageLinkCell : SGTableViewCellBase
{
    SGSearchMessageLinkModel *_model;
    UIImageView *_iconIV;
    UILabel *_nameLabel;
    UILabel *_timeLable;
    UILabel *_titleLable;
...
@property(retain, nonatomic) SGSearchMessageLinkModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
