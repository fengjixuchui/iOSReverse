...
@class AVPlayerItem, AVPlayerItemVideoOutput, CADisplayLink, NSString, SCImageView;
@protocol SCPlayerDelegate;

@interface SCPlayer : AVPlayer <AVPlayerItemOutputPullDelegate, AVPlayerItemOutputPushDelegate>
{
...
@property(nonatomic) __weak id <SCPlayerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
