...
@interface JrmfServiceChargeViewController : JYangWalletViewController <SelectedCardDelegate, WalletSubBankDelegate, WalletVriPwdDelegate, UITextFieldDelegate, UIAlertViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource>
{
...
- (void)itemTFieldValueChange:(id)arg1;
