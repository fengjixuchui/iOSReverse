...
#import "OrderListDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class ASHandle, NSMutableArray, NSString, SGSetGameLoadingView, UITableView, UIView;

@interface SGMyOrderViewController : SGViewController <UITableViewDelegate, UITableViewDataSource, OrderListDelegate, ASWatcher>
{
...
- (void)showExpressTrances:(id)arg1;
- (void)contactGroup:(id)arg1;
- (void)payGoods:(id)arg1;
