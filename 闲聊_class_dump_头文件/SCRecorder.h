...
@class AVCaptureAudioDataOutput, AVCaptureMovieFileOutput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, CIContext, NSError, NSString, NSTimer, SCAudioConfiguration, SCFilter, SCImageView, SCPhotoConfiguration, SCRecordSession, SCSampleBufferHolder, SCVideoConfiguration, UIView;
