...
@class JYWebImageManager, NSArray;
@protocol JYWebImagePrefetcherDelegate;

@interface JYWebImagePrefetcher : NSObject
{
    JYWebImageManager *_manager;
    unsigned long long _options;
    id <JYWebImagePrefetcherDelegate> _delegate;
...
@property(nonatomic) __weak id <JYWebImagePrefetcherDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) unsigned long long options; // @synthesize options=_options;
@property(retain, nonatomic) JYWebImageManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
