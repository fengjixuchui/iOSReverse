...
@class NSMutableArray, NSString, SGDialogs, SGGroupInfo, UITableView;

@interface SGGroupMemberActiveController : SGViewController <UITableViewDelegate, UITableViewDataSource>
{
