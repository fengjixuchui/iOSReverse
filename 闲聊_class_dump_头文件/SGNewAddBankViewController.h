...
@interface SGNewAddBankViewController : SGViewController <UITextFieldDelegate>
{
...
@property(retain, nonatomic) UITextField *carIDField; // @synthesize carIDField=_carIDField;
