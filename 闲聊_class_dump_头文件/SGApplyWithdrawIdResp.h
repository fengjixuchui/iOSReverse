...
@interface SGApplyWithdrawIdResp : SGHTTPSResponseModel
{
    long long _withdrawId;
    long long _cashAmount;
    long long _availableWithdrawAmount;
    long long _unlockTime;
}

+ (int)constructor;
@property(nonatomic) long long unlockTime; // @synthesize unlockTime=_unlockTime;
@property(nonatomic) long long availableWithdrawAmount; // @synthesize availableWithdrawAmount=_availableWithdrawAmount;
