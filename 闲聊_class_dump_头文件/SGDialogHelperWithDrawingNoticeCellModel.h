...
@interface SGDialogHelperWithDrawingNoticeCellModel : SGDialogDetailCellModel
{
    NSString *_titleText;
    ...
    NSString *_withdrawTimeStr;
}

@property(copy, nonatomic) NSString *withdrawTimeStr; // @synthesize withdrawTimeStr=_withdrawTimeStr;
