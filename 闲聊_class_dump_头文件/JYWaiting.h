...
@class JYBackgroundView, NSArray, NSDate, NSString, NSTimer, UIButton, UIColor, UIFont, UILabel;
@protocol JYWaitingDelegate;

@interface JYWaiting : UIView
{
    ...
    float _progress;
    id <JYWaitingDelegate> _delegate;
    double _graceTime;
    double _minShowTime;
    long long _mode;
    ...
    double _margin;
    JYBackgroundView *_bezelView;
    JYBackgroundView *_backgroundView;
    UIView *_customView;
    UILabel *_label;
...
+ (id)WaitForView:(id)arg1;
+ (_Bool)hideWaitForView:(id)arg1 animated:(_Bool)arg2;
+ (id)showWaitAddedTo:(id)arg1 animated:(_Bool)arg2;
...
@property(readonly, nonatomic) JYBackgroundView *backgroundView; // @synthesize backgroundView=_backgroundView;
@property(readonly, nonatomic) JYBackgroundView *bezelView; // @synthesize bezelView=_bezelView;
...
@property(nonatomic) __weak id <JYWaitingDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
