...
@class AVCaptureConnection, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoPreviewLayer, MGCameraRecordManager, NSDictionary, NSString;
@protocol MGCameraDelegate, OS_dispatch_queue;

@interface MGCameraManager : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, MGCameraRecordDelegate>
{
    ...
    MGCameraRecordManager *_recordManager;
}
...
@property(retain, nonatomic) MGCameraRecordManager *recordManager; // @synthesize recordManager=_recordManager;
...
- (void)startSilentLiveRecording:(unsigned long long)arg1;
- (void)silentLiveWithMoveName:(id)arg1;
- (id)stopRceording;
- (void)startRecording;
- (void)stopRunning;
- (void)startRunning;
