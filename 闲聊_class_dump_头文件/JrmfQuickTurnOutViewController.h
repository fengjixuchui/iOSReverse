...
@interface JrmfQuickTurnOutViewController : JYangWalletViewController <SelectedCardDelegate, WalletSubBankDelegate, WalletVriPwdDelegate, UITextFieldDelegate, UIAlertViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource>
{
