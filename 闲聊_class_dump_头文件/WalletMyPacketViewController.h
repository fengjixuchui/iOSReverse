...
@class NSMutableArray, NSString, UISegmentedControl, UITableView, WalletPacketInfoObj;

@interface WalletMyPacketViewController : JYangWalletViewController <UITableViewDelegate, UITableViewDataSource>
{
    _Bool isReceive;
    ...
    WalletPacketInfoObj *_currentModel;
}

@property(retain, nonatomic) WalletPacketInfoObj *currentModel; // @synthesize currentModel=_currentModel;
...
- (void)postGetOpenPacketDetailRequestWithPacketID:(id)arg1;
