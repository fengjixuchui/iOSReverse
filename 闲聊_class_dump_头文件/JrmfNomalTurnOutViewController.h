...
@class NSMutableArray, NSString, UIButton, UILabel, UIPickerView, UIThemeButton, UIView, WalletCardInfoObj, WalletItemView, WalletTurnView;

@interface JrmfNomalTurnOutViewController : JYangWalletViewController <SelectedCardDelegate, WalletSubBankDelegate, WalletVriPwdDelegate, UITextFieldDelegate, UIAlertViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource>
{
...
@property(nonatomic) _Bool backToTop; // @synthesize backToTop=_backToTop;
