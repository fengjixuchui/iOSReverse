...
@interface SGShareSpecialGameCell : SGDialogDeatilBaseCell
{
    UILabel *_nameLab;
    UILabel *_gameTitleLab;
...
@property(nonatomic) __weak UILabel *gameTitleLab; // @synthesize gameTitleLab=_gameTitleLab;
