...
@class InterestTribeType, NSMutableArray, NSString, SGSetGameLoadingView, UITableView, UIView;

@interface SGSigalInsterstViewController : SGViewController <UITableViewDataSource, UITableViewDelegate>
{
    int _pageNo;
