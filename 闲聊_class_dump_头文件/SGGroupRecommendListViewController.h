...
@interface SGGroupRecommendListViewController : SGGoodsBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, SGHomePageCustomLayoutDelegate>
{
    int _pageNo;
    long long _groupId;
