...
@class NSString, SGRedPacketBannerModel, UIColor, UIFont, UIImageView, UILabel;
...
@interface SDCollectionViewCell : UICollectionViewCell
{
    ...
    SGRedPacketBannerModel *_bannerModel;
}

@property(retain, nonatomic) SGRedPacketBannerModel *bannerModel; // @synthesize bannerModel=_bannerModel;
