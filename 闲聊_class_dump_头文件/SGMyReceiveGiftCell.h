...
@class SGReceivedGiftItem, UIImageView, UILabel, UIView;

@interface SGMyReceiveGiftCell : UICollectionViewCell
{
    SGReceivedGiftItem *_itemModel;
    UILabel *_nameLab;
...
@property(retain, nonatomic) SGReceivedGiftItem *itemModel; // @synthesize itemModel=_itemModel;
- (void).cxx_destruct;
- (void)setChildView;
